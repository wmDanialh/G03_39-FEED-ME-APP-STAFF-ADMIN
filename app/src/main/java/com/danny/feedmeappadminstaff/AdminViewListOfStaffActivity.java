...
public class AdminViewListOfStaffActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_view_list_of_staff);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(AdminViewListOfStaffActivity.this, AdminRegisterStaffActivity.class);
            ...
            public void onBindViewHolder(@NonNull StaffViewHolder holder, int position, @NonNull Staff model) {
                ...
                holder.setItemClickListener(new ItemClickListener() {
                    ...
                    public void onClick(View view, int position, boolean isLongClick) {
                        ...
                        Toast.makeText(AdminViewListOfStaffActivity.this, "" + clickItem.getStaffName(), Toast.LENGTH_SHORT).show();
                    }
                });
    ...
    private void deleteStaff(String uid){
        //FirebaseDatabase firebaseDatabase = FirebaseDatabase.getInstance();
        DatabaseReference staff = FirebaseDatabase.getInstance().getReference("Staff").child(uid);
        DatabaseReference staff_id = FirebaseDatabase.getInstance().getReference("Staff").child(firebaseAuth.getUid());
        //Staff userProfile = new Staff(address,email, mobile, name, uid);
        //staff.child(key).removeValue();
        staff.child(FirebaseAuth.getInstance().getCurrentUser().getUid());
        staff.removeValue();
