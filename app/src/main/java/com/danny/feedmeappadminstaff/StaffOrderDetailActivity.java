...
public class StaffOrderDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar toolbar = findViewById(R.id.toolbarStaffOrderDetail);
        ...
        order_id = (TextView)findViewById(R.id.Stafforder_info_id);
        order_phone = (TextView)findViewById(R.id.Staff_order_phone);
        order_address = (TextView)findViewById(R.id.Staff_order_info_address);
        order_total = (TextView)findViewById(R.id.Staff_order_info_total);
        order_comment = (TextView)findViewById(R.id.Staff_order_info_comment);

        listfoods = (RecyclerView)findViewById(R.id.listFoodStaffDetails);
