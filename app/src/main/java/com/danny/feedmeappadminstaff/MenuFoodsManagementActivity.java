...
public class MenuFoodsManagementActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_menu_foods_management);
    ...
    private void showAddFoodDialog() {
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(MenuFoodsManagementActivity.this);
        ...
        alertDialog.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                if(newFood != null)
                {
                    ...
                    Toast.makeText(MenuFoodsManagementActivity.this,"New Foods " +newFood.getName()+ "has been added", Toast.LENGTH_SHORT).show();
                }
            ...
            protected void onBindViewHolder(@NonNull FoodViewHolder viewHolder, int position, @NonNull final Food model) {
                ...
                viewHolder.setItemClickListener(new ItemClickListener() {
                    ...
                    public void onClick(View view, int position, boolean isLongClick) {
                        ...
                        Toast.makeText(MenuFoodsManagementActivity.this, "" + local.getName(), Toast.LENGTH_SHORT).show();
                    }
                });
            }
            ...
            imageFolder.putFile(saveUri)
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            mDialog.dismiss();
                            Toast.makeText(MenuFoodsManagementActivity.this,"Picture are uploaded", Toast.LENGTH_SHORT).show();
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            mDialog.dismiss();
                            Toast.makeText(MenuFoodsManagementActivity.this,""+e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    })
    ...
    private void showUpdateFoodDialog(final String key, final Food item) {
        ...
        alertDialog.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                    ...
                    Toast.makeText(MenuFoodsManagementActivity.this,"New Foods " +item.getName()+ "has been updated", Toast.LENGTH_SHORT).show();
