...
public class MenuManagementActivity extends AppCompatActivity {
    ...
    private void showDialog() {
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(MenuManagementActivity.this);
        ...
        alertDialog.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                if(foodCategoryModel != null)
                {
                    ...
                    Toast.makeText(MenuManagementActivity.this,"New Category " +foodCategoryModel.getName()+ "has been added", Toast.LENGTH_SHORT).show();
                }
            ...
            imageFolder.putFile(saveUri)
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            mDialog.dismiss();
                            Toast.makeText(MenuManagementActivity.this,"Picture are uploaded", Toast.LENGTH_SHORT).show();
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            mDialog.dismiss();
                            Toast.makeText(MenuManagementActivity.this,""+e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    })
    ...
    private void loadMenu() {
        ...
        adapter = new FirebaseRecyclerAdapter<FoodCategoryModel, MenuViewHolder>(options) {
            ...
            public void onBindViewHolder(@NonNull MenuViewHolder holder, int position, @NonNull FoodCategoryModel model) {
                ...
                Picasso.with(MenuManagementActivity.this).load(model.getImage()).fit().into(holder.imageView);
                ...
                holder.setItemClickListener(new ItemClickListener() {
                    ...
                    public void onClick(View view, int position, boolean isLongClick) {
                        Intent foodlist = new Intent(MenuManagementActivity.this, MenuFoodsManagementActivity.class);
                        foodlist.putExtra("CategoryId",adapter.getRef(position).getKey());
                        startActivity(foodlist);
                        //Because CategoryId is key, so we just get key of this item
                        Toast.makeText(MenuManagementActivity.this, "" + clickItem.getName(), Toast.LENGTH_SHORT).show();
                    }
                });
    ...
    private void deleteCategory(String key) {
        ...
        Toast.makeText(MenuManagementActivity.this,"Category hase been deleted",Toast.LENGTH_SHORT).show();
    }
